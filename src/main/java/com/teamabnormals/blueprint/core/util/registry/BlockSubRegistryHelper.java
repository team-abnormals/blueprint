...
public class BlockSubRegistryHelper extends AbstractSubRegistryHelper<Block, DeferredRegister.Blocks> {
	...
	public BlockSubRegistryHelper(RegistryHelper parent) {
		this(parent, parent.getSubHelper(Registries.ITEM));
	}

	public BlockSubRegistryHelper(RegistryHelper parent, ISubRegistryHelper<Item> itemHelper) {
		this(parent, itemHelper.getDeferredRegister(), DeferredRegister.createBlocks(parent.getModId()));
	}
	 ...
	 * @return A {@link DeferredBlock} containing the created {@link Block}.
	 */
	 ...
	 * @return A {@link DeferredBlock} containing the created {@link BlueprintChestBlock}.
	 */
	public DeferredBlock<BlueprintChestBlock> createChestBlock(String name, String materialName, Block.Properties properties) {
	 ...
	 * @return A {@link DeferredBlock} containing the created {@link BlueprintChestBlock}.
	 */
	public DeferredBlock<BlueprintChestBlock> createChestBlock(String materialName, Block.Properties properties) {
	 ...
	 * @return A {@link DeferredBlock} containing the created {@link BlueprintTrappedChestBlock}.
	 */
	 ...
	 * @return A {@link DeferredBlock} containing the created {@link BlueprintTrappedChestBlock}.
	 */
	public DeferredBlock<BlueprintTrappedChestBlock> createTrappedChestBlock(String materialName, Block.Properties properties) {
	 ...
	 * @return A {@link Pair} containing {@link DeferredBlock} instances of the {@link BlueprintStandingSignBlock} and the {@link BlueprintWallSignBlock}.
	 */
	public Pair<DeferredBlock<BlueprintStandingSignBlock>, DeferredBlock<BlueprintWallSignBlock>> createSignBlock(String name, WoodType woodType, Block.Properties properties) {
		DeferredBlock<BlueprintStandingSignBlock> standing = this.deferredRegister.register(name + "_sign", () -> new BlueprintStandingSignBlock(properties, woodType));
		DeferredBlock<BlueprintWallSignBlock> wall = this.deferredRegister.register(name + "_wall_sign", () -> new BlueprintWallSignBlock(properties.lootFrom(standing), woodType));
	 ...
	 * @param name     The name for the sign blocks.
	 * @param woodType The {@link WoodType} for the sign blocks. <b>Also call {@link com.teamabnormals.blueprint.core.api.WoodTypeRegistryHelper#registerWoodType(WoodType)} on this</b>!
	 * @return A {@link Pair} containing {@link DeferredBlock} instances of the {@link BlueprintCeilingHangingSignBlock} and the {@link BlueprintWallHangingSignBlock}.
	 */
	public Pair<DeferredBlock<BlueprintCeilingHangingSignBlock>, DeferredBlock<BlueprintWallHangingSignBlock>> createHangingSignBlock(String name, WoodType woodType, Block.Properties properties) {
		DeferredBlock<BlueprintCeilingHangingSignBlock> ceiling = this.deferredRegister.register(name + "_hanging_sign", () -> new BlueprintCeilingHangingSignBlock(properties, woodType));
		DeferredBlock<BlueprintWallHangingSignBlock> wall = this.deferredRegister.register(name + "_wall_hanging_sign", () -> new BlueprintWallHangingSignBlock(properties.lootFrom(ceiling), woodType));
