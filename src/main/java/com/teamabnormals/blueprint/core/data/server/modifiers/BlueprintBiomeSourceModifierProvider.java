...
public final class BlueprintBiomeSourceModifierProvider extends BiomeSourceModifierProvider {
	...
	protected void registerModifiers() {
		this.registerModifier("originals", new BiomeUtil.OriginalModdedBiomeProvider(new ResourceLocation(Blueprint.MOD_ID, "originals"), 10), LevelStem.OVERWORLD.location(), LevelStem.NETHER.location(), LevelStem.END.location());
	}
