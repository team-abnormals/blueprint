...
public enum PlushCampaignHandler {
    ...
    private static final ResourceLocation CAMPAIGN_TEXTURE = Blueprint.location("textures/plush_campaign.png");
    ...
    public void setup() {
        if (PlushCampaignHandler.isEligible()) NeoForge.EVENT_BUS.addListener(this::onScreenInit);
    }
    ...
    private static final class CampaignScreen extends Screen {
        ...
        @Override
        protected void init() {
            this.neverShowAgainCheckbox = Checkbox.builder(NEVER_SHOW_AGAIN_COMPONENT, this.font)
                    .maxWidth(this.font.width(NEVER_SHOW_AGAIN_COMPONENT) + 24)
                    .selected(false)
                    .build();
        ...
        public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
            ...
            RenderSystem.enableBlend();
            guiGraphics.blit(Screen.HEADER_SEPARATOR, this.panelLeft, PANEL_TOP - 2, 0.0F, 0.0F, PANEL_WIDTH, 2, 32, 2);
            guiGraphics.blit(Screen.FOOTER_SEPARATOR, this.panelLeft, this.panelBottom, 0.0F, 0.0F, PANEL_WIDTH, 2, 32, 2);
            RenderSystem.disableBlend();
