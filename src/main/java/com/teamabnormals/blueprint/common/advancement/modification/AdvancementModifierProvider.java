...
public abstract class AdvancementModifierProvider extends ObjectModifierProvider<BlueprintAdvancementBuilder, RegistryOps<JsonElement>, RegistryOps<JsonElement>> {
