...
public class LootInjectionRegistry {
	...
	public static class LootInjector {
		 ...
		 * <p>This method internally has the same effect as {@link #registerLootInjection(LootPool, ResourceLocation...)}, with the difference being it builds the {@link LootPool}.</p>
		 *
		 ...
		 * @see #registerLootInjection(LootPool, ResourceLocation...)
		 * @see #addLootInjector(Set, LootPool)
		 */
		public void registerLootInjection(String name, int weight, int quality, ResourceLocation... locations) {
