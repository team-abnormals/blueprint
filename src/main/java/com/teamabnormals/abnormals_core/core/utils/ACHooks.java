...
public final class ACHooks {
	...
	public static void addSlabfishButton(CustomizeSkinScreen screen, int i) {
		...
		try {
			...
			}, (button, stack, mouseX, mouseY) -> screen.renderTooltip(stack, minecraft.fontRenderer.func_238425_b_(new TranslationTextComponent(SlabfishHatScreen.SLABFISH_SCREEN_KEY + ".tooltip", new StringTextComponent("patreon.com/teamabnormals").modifyStyle(style -> style.setColor(Color.func_240745_a_("#FF424D")))), 200), mouseX, mouseY)));
