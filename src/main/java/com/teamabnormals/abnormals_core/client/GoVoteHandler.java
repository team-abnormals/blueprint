 ...
 */
@EventBusSubscriber(modid = AbnormalsCore.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class GoVoteHandler {
	private static final String BRAND = "Team Abnormals";
		...
		try {
			...
			*/
			...
			if (ex instanceof FileAlreadyExistsException) {
				AbnormalsCore.LOGGER.debug("Go vote handler: Marker already exists");
			}
