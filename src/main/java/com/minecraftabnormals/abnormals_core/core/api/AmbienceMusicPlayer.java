...
public class AmbienceMusicPlayer {
	 ...
	 * @param biomes - Biome to play the ambiance in
	 ...
	 */
	public static synchronized void registerBiomeAmbientSoundPlayer(List<Supplier<Biome>> biomes, Supplier<SoundEvent> loopSound, Supplier<SoundEvent> additionSound, Supplier<SoundEvent> moodSound) {
		SOUND_HANDLERS.add(new BiomeAmbientSoundPlayer(biomes, loopSound, additionSound, moodSound));
	}
