...
public final class TestChunkGeneratorModifiersProvider extends ChunkGeneratorModifierProvider {
	...
	protected void registerEntries() {
		this.entry("overworld_crimson_forest_surface_rule")
				...
				.addModifier(new SurfaceRuleModifier(ifTrue(new BlueprintSurfaceRules.ModdednessSliceConditionSource(new ResourceLocation("blueprint_test:overworld_test")), ifTrue(isBiome(Biomes.CRIMSON_FOREST), sequence(ifTrue(SurfaceRules.ON_FLOOR, state(Blocks.CRIMSON_NYLIUM.defaultBlockState())), state(Blocks.NETHERRACK.defaultBlockState())))), false));
	}
